        ...
        <div className='xl:w-[65%] lg:w-[75%] md:w-[85%] sm:w-[90%] w-[90%] flex flex-col sm:flex-row md:gap-10 '>
          <div className='flex flex-col sm:max-w-[46%] py-8 justify-around'>
            <div className='flex flex-col w-full'>
              <img src="../public/logo.png" alt="Logo" className='w-72 sm:w-48 object-cover self-center sm:self-start' />
          ...
          <div className='flex sm:pt-6 items-end'>
            <img src="../public/patricia.png" alt="Doutora patrícia" className='object-contain lg:max-w-[95%] xl:max-w-[90%]' />
          </div>
        </div>
      </header>
    </div>
