  ...
  return (
    <div className=''>
        <div className='flex justify-center'>
            <h2 className='text-3xl sm:text-4xl font-semibold text-gray-600 py-10 px-4 text-center'> Aracaju/SE - Centro Médico Jardins, sala <span className='font-Roboto'>702</span> </h2>
        </div>
